        ...
        <CardContent className="px-3 sm:px-4 pb-4 relative w-full">
          {recentTransactions.length === 0 ? (
            <div className="flex flex-col items-center gap-2 py-8 text-muted-foreground">
              ...
              <Link href="/transaction/create" prefetch={true} className="text-xs text-purple-500 hover:underline">Add your first one →</Link>
            </div>
          ) : (
      ...
      <Card className="pb-2 w-full relative overflow-hidden">
        <CardHeader className="pb-3 flex flex-col items-start gap-1 w-full">
          ...
          <div className="text-sm font-medium text-muted-foreground w-full">
            Total: <span className="font-bold text-rose-500 text-base tabular-nums">{formatCurrency(totalExpenseThisMonth, userCurrency)}</span>
          </div>
        </CardHeader>
