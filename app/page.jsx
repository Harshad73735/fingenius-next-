...
export default function Home() {
  return <div className="mt-40 bg-white dark:bg-slate-900">
<HeroSection />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuresData.map((feature, index) => (
              <Card className="p-6 dark:bg-slate-800" key={index}>
...
<section className="py-20 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500">
  <div className="container mx-auto px-4 text-center">
    ...
    <p className="text-pink-100 mb-8 max-w-2xl mx-auto">
      FinGenius empowers you to make confident financial decisions every day.
    </p>
    <Link href="/dashboard">
      <Button
        size="lg"
